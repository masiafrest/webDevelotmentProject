...
<body>
	...
	<h1 class="text-center">Addmision Test</h1>
	
	<section style="padding: 2%; background-color:#E6E6E6; height: 50%; text-align: center;" >
		...
		if($score >= 2)
			echo "<br><h4>Congratulation!!</h4><br>your score is $score so you are qualify.";
		else
			echo "your score is $score you need to study more";
		?>
	</section>

	<div class="footer fixed-bottom bg-secondary pt-3">
